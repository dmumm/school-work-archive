...
/*If the user selectis to read the data from a file and stores it in the 2D
...
void propogateGuess(int, int, int, int, int*, int**, int**);
...
void playBasicGame(int, int, int**, int**);
void playAdvancedGame(int,int, int**, int**);
