...
###############################################################################
    ...
    def max_value(player, board, depth_limit):
        ...
        for child in children:
            new_board = child[1]
            new_v, new_placement = value(next_player, new_board, depth_limit-1)
            if new_v > v:
                v, placement = new_v, child[0]
...
###############################################################################
    def value(player, board, depth_limit, a, b):
        ...
        if depth_limit == 0 or board.terminal():
            ...
            if player == board.PLAYER1:
                ...
                return min_value(next_player, board, depth_limit, a, b)
    ...
    def max_value(player, board, depth_limit, a, b):
        ...
        for child in children:
            new_board = child[1]
            new_v, new_placement = value(next_player, new_board, depth_limit-1, a, b)
            if new_v > v: v, placement = new_v, child[0]
            if v >= b: break
            a = max(a, v)
...
###############################################################################
    ...
    def min_value(player, board, depth_limit):
        ...
        new_board = child[1]
        v, placement = value(next_player, new_board, depth_limit-1)
