...
/* main() averages 16 values from stdin and prints the average */
main:

    push {lr}    // save lr

    add sp, sp, #-64 // allows storage of 16 ints of size 4
    ...
    lsr r6, #4        // divides sum by 16 to achieve average
  	mov r1, r6			  // moving average to r1
  	bl printf			    // calling printf

  	add sp, sp, #64		// clearing stack
